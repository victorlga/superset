...
configOverrides:
  enable_oauth: |
    ...
    # Will allow syncing of new users from LDAP/OAuth/SAML providers
    AUTH_USER_REGISTRATION = True

    # Optionally enable public self-registration via the login page UI
    # (disabled by default for security — only enable if you want anyone to register)
